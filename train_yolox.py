...
from loss import YOLOXLoss as loss_fnc
...
class Training:
    ...
    def before_train(self):
        ...
        model = self.select_model(num_anchors=self.hyp['num_anchors'], num_classes=self.train_dataset.num_class, prior_prob=self.hyp['weight_init_prior_prob'])
        ModelSummary(model, 
...
def main(x):
    ...
    class Args:
        def __init__(self) -> None:
            self.cfg = "./config/train_yolox.yaml"
    args = Args()
