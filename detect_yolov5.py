...
class Detection:
    ...
    def __init__(self, anchors, hyp, is_training=True):
        self.hyp = hyp
        ...
        if self.testdataset.num_class == 0:
            ...
            self.testdataset.class2label = ['lab' for _ in range(num_class)]
    ...
    def predtict(self):
        ...
        """
        for i, x in tqdm(enumerate(self.testdataloader), total=len(self.testdataloader), ncols=100):
            ...
            if self.hyp['save_img']:
                for k in range(len(imgs)):
                    ...
                    if gt_cls is not None:
                        gt_lab = [self.testdataset.cl2lab[int(c)] for c in gt_cls[k]]
    ...
    def detect_all(self):
        ...
        pred_bboxes, pred_classes, pred_confidences, pred_labels = [], [], [], []
